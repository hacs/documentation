...
With all rules, there will at some point exist exceptions.

For HACS and add-ons that is now the [Get HACS add-on](https://github.com/hacs/addons) that was made for the Home Assistant Operating System and Supervised to simplify the initial download of HACS itself.
