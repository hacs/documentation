...
=== "OS/Supervised"
    ...
    3. **Start** the app.
    4. Navigate to **Settings** > **System** > **Logs** and select **Get HACS** from the top right drop down to see the **Get HACS** logs.  Check these in case there  are additional instructions to follow for your system.
