...
You must provide brand assets for your integration. This is done by adding a [`brand` directory in your repository](https://developers.home-assistant.io/docs/creating_integration_file_structure#brand-images---brand) with at least an `icon.png` file.
