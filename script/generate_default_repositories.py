...
REPOSITORY_NOTES= {
    "zachowj_hass_node_red": "This will not give you NodeRED, only an integration used by it, this is not NodeRED as that is separate software and HACS does not install additional software, this is not the NodeRED add-on as [HACS does not manage add-ons](/docs/faq/addons)"
}
